...
const MOCK_PROVIDER: Provider = {
  ...
  resolveNumberEvaluation: (): Promise<ResolutionDetails<number>> => Promise.resolve({ value: 1, reason: 'STATIC' }),
...
const MOCK_PROVIDER_2: Provider = {
  ...
  resolveNumberEvaluation: (): Promise<ResolutionDetails<number>> => Promise.resolve({ value: 2, reason: 'STATIC' }),
  resolveObjectEvaluation: <T>(): Promise<ResolutionDetails<T>> =>
    Promise.resolve({ value: {} as T, reason: 'STATIC' }),
};
